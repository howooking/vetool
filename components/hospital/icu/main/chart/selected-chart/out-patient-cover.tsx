...
export default function OutPatientCover() {
  ...
  return (
    <div className="absolute left-0 right-0 top-0 flex h-full cursor-not-allowed justify-center">
      <div
        className="fixed top-1/2 flex translate-y-[-50%] flex-col gap-1 rounded-sm text-destructive transition-opacity duration-500"
        style={{ opacity }}
      >
        <span className="text-3xl font-bold">퇴원한 환자입니다</span>
